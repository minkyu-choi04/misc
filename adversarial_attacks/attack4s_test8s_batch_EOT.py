...
def attack_LinfPGD(args, model_o, eps_list, n_steps=16, batch_size=128, img_s_load=256+128, img_s_return=224+112, cudnn_backends=True, n_iter=5, eps_iter=3, es=None, compensation=0):
    '''
