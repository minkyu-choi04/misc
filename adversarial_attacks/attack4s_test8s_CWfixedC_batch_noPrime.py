...
def attack_L2CWAttack(args, model_o, c_list, n_steps=16, batch_size=128, img_s_load=256+128, img_s_return=224+112, cudnn_backends=True, es=10,
        learning_rate=0.01, max_iterations=10000):
    '''
    ...
    for c in c_list:
        ...
        attack = advertorch.attacks.CarliniWagnerL2Attack(model, num_classes=100, learning_rate=learning_rate, binary_search_steps=1, 
                max_iterations=max_iterations, initial_const=c)
