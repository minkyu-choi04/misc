...
from advertorch.attacks import EOT_GradientSignAttack
from advertorch.utils import NormalizeByChannelMeanStd
from advertorch_examples.utils import get_panda_image, bchw2bhwc, bhwc2bchw


def attack_FGSM_EOT_targeted(args, model_o, eps_list, n_steps=16, batch_size=128, img_s_load=256+128, img_s_return=224+112, cudnn_backends=True, 
        es=None, compensation=0, n_EOT=1, isAvgSteps=False, 
        shuffle_test=False, save_imgs=False):
    '''
    ...
    print('FGSM-EOT: {} iterations'.format(n_EOT))
        ...
        for batch_i, data in enumerate(val_loader):
            ...
            if save_imgs:
                ...
                for step in range(n_steps):
                    ...
                    #       'plots', 'test_e'+str(0)+'b'+str(batch_i)+'_fix_hist'+'_s'+str(step))
