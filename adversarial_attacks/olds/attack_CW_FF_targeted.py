...
def attack_L2CW(args, model_o, eps_list, batch_size=128, img_s_load=256, img_s_return=224, cudnn_backends=True, path=None, n_iter=40, eps_iter=5, save_more=True, save_imgs=False):
    '''
    ...
    #for eps in [0.001, 0.002, 0.003, 0.005, 0.01]:
        ...
        for batch_i, data in enumerate(val_loader):
            ...
            if batch_i == 0:
                ...
                #tf_clean = torch.cat((tf_clean, tf), 0)
