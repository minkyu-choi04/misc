...
def attack_LinfSPSAAttack_allSteps(args, model_o, eps_list, n_sample=8192, n_steps=16, batch_size=32, img_s_load=256+128, img_s_return=224+112, cudnn_backends=True, 
    ...
    for eps in eps_list:
        ...
        attack = LinfSPSAAttack_allSteps(model, eps=eps, delta=delta, lr=0.01, nb_iter=n_iter, nb_sample=n_sample, max_batch_size=max_batch_size)
        '''
