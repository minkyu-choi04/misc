...
def attack_LinfPGD(args, model_o, eps_list, batch_size=128, img_s_load=256, img_s_return=224, cudnn_backends=True, n_iter=5, eps_iter=3, es=None):
    '''
    ...
    val_loader = dl.load_imagenet_myclass100_val1000_for_AdvAttacks(batch_size=batch_size, img_s_load=img_s_load, img_s_return=img_s_return, server_type=args.server_type, shuffle_test=False)
    print('\n\n=============================')
