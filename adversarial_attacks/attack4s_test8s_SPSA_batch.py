...
def attack_LinfSPSAAttack(args, model_o, eps_list, n_sample=8192, n_steps=16, batch_size=32, img_s_load=256+128, img_s_return=224+112, cudnn_backends=True, n_iter=100, delta=0.01, es=None):
    '''
