...
def load_mscoco_multilabel(batch_size, img_s_load=256, img_s_return=224, server_type='libigpu5', isRandomResize=True, num_workers=4, num_workers_t=None, shuffle_val=False):
    '''
