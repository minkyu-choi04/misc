...
def load_imagenet_myclass100_val100_for_AdvAttacks(batch_size=1, img_s_load=256+128, img_s_return=224+112, server_type='libigpu5', isRandomResize=True, 
        num_workers=1, shuffle_test=False, isReturnInfo=False, drop_last=True):
    if server_type == 'libigpu4':
        path = '/home/choi574/datasets/ImageNet2012_myclass100_val100/'
    elif server_type == 'libigpu5':
        path = '/home/choi574/datasets/ImageNet2012_myclass100_val100/'
    elif server_type == 'libigpu6':
        path = '/home/choi574/datasets/ImageNet2012_myclass100_val100/'
        ...
        path = '/home/min/datasets/ImageNet2012_myclass100_val100/'
    elif server_type == 'libigpu1':
        path = '/home/min/datasets/ImageNet2012_myclass100_val100/'
    elif server_type == 'libigpu3':
        path = '/home/min/datasets/ImageNet2012_myclass100_val100/'
        ...
        path = '/tmp/minkyu/ImageNet2012_myclass100_val100/'
    else:
        print("undefined server type")
    print(server_type, os.path.expanduser(path + 'val/'))
    print('================ MY CLASS 100 IMGNET: VAL100 =================== ')
...
def load_imagenet_myclass100_val1000_for_AdvAttacks(batch_size=1, img_s_load=256+128, img_s_return=224+112, server_type='libigpu5', isRandomResize=True, 
        num_workers=1, shuffle_test=False, isReturnInfo=False):
    if server_type == 'libigpu4':
        path = '/home/choi574/datasets/ImageNet2012_myclass100_val1000/'
    elif server_type == 'libigpu5':
        path = '/home/choi574/datasets/ImageNet2012_myclass100_val1000/'
    elif server_type == 'libigpu6':
        path = '/home/choi574/datasets/ImageNet2012_myclass100_val1000/'
        ...
        path = '/home/min/datasets/ImageNet2012_myclass100_val1000/'
    elif server_type == 'libigpu1':
        path = '/home/min/datasets/ImageNet2012_myclass100_val1000/'
    elif server_type == 'libigpu3':
        path = '/home/min/datasets/ImageNet2012_myclass100_val1000/'
        ...
        path = '/tmp/minkyu/ImageNet2012_myclass100_val1000/'
    else:
        print("undefined server type")
    print('================ MY CLASS 100 IMGNET: VAL1000  =================== ')
